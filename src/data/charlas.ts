...
},
{
...

  {
    ...
    textoEs: "**Melissa Robles** es matemática con maestría en Ingeniería de Sistemas y nos presenta su investigación sobre la detección de sesgos en modelos supervisados y modelos de lenguaje, con especial atención a los sesgos contextuales en el idioma español.",
    textoEn: "**Melissa Robles** is a mathematician with a master's degree in Systems Engineering, and she presents her research on bias detection in supervised models and language models, with particular attention to contextual biases in the Spanish language.",
