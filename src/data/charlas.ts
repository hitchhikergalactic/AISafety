...
export const listaDeCharlas: Charla[] = [
...

  {
    ...
    presentacion: "/material_seminario_bernabeu_perez.pdf",
    expositor: {
      id: "pablo-bernabeu",
      nombre: "Pablo",
...

  {
    ...
    descripcionCortaEs: "Mariana analiza el Sesgo Lingüístico Digital como problema de gobernanza: qué implica que los grandes modelos de lenguaje no representen adecuadamente al mundo hispanohablante.",
    descripcionCortaEn: "Mariana examines Digital Linguistic Bias as a governance problem: what it means that large language models fail to adequately represent the Spanish-speaking world.",
...
{
    id: "carrera-ia-safety-buenos-aires",
    tagEs: "Carrera profesional",
    tagEn: "Career",
...
nombre: "Eitan",
apellido: "Sprejer",
tituloEs: "**Investigador en seguridad de IA y cofundador de BAISH**",
tituloEn: "**AI safety researcher and co-founder of BAISH**",
imagen: "",
bioEs: "Eitan es investigador en seguridad de IA a tiempo completo gracias al programa AISAR Scholarships y a la Apart Lab Fellowship, y ha coautorado investigaciones aceptadas en workshops de NeurIPS, entre ellas trabajos sobre persuasión en modelos de lenguaje y sobre monitorabilidad de chain of thought. Se licenció en Física en la Universidad de Buenos Aires, con un grado equivalente a licenciatura más máster, y ha ejercido como profesor ayudante en dos ediciones de los campamentos ML4G, además de facilitador del curso AISES del Center for AI Safety y, en la actualidad, del curso AGI Strategy de BlueDot Impact. Es cofundador de BAISH, la comunidad de seguridad en IA más grande y consolidada de Latinoamérica, con financiación de Open Philanthropy y más de ciento cincuenta miembros, y también cofundó LANAIS, la Red Latinoamericana de IA Safety.",
bioEn: "Eitan is a full time AI safety researcher through the AISAR Scholarships programme and the Apart Lab Fellowship, and has co-authored research accepted at NeurIPS workshops, including work on AI persuasion and on chain of thought monitorability. He holds a bachelor's plus master's degree in Physics from the University of Buenos Aires, and has served as a teaching assistant at ML4G camps on two occasions, as well as a facilitator for the Center for AI Safety's AISES course and, currently, for BlueDot Impact's AGI Strategy course. He is co-founder of BAISH, the largest and most established AI safety community in Latin America, with funding from Open Philanthropy and over one hundred and fifty members, and he also co-founded LANAIS, the Latin American AI Safety Network.",
