...
export const listaDeCharlas: Charla[] = [
...

  {
    ...
    descripcionCortaEn: "Can AI deceive us in its own reasoning? Pablo presents CoT Red-Handed, exploring the limits and solutions for monitoring AI chains of thought.",    imagen: "",
    fecha: "2026-02-04",
