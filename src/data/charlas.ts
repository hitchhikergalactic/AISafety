...
export const listaDeCharlas: Charla[] = [
  {
    ...
    descripcionCortaEs: "Jaime llegó a la seguridad de la IA a través de un hackathon y hoy lidera Apart Research. Descubre cómo construir una carrera real en seguridad de la IA desde cero.",
    ...
    expositor: {
      ...
      imagen: "", 
      bioEs: "Ingeniero industrial formado en la **Universidad Politécnica de Madrid** y la **Universidad Técnica de Múnich**, con más de 8 años de experiencia en el sector tecnológico.Tras trabajar en **ITK Engineering**(Grupo BOSCH) y el **Centro Aeroespacial Alemán (DLR)**, dio el salto a la seguridad de la IA a través de un hackathon de **Apart Research**. En la organización ascendió de *Research Engineer* a *CTO* hasta asumir el cargo de *CEO*. Es coautor de una investigación publicada en la revista **Science** sobre la evaluación de riesgos de IA bajo la **EU AI Act**.",
...

  {
    ...
    expositor: {
      ...
      tituloEs: "**Investigador en seguridad de la IA, LASR Labs**",
  ...
  },
  {
    ...
    tagEs: "Investigación Técnica",
    tagEn: "Technical Research",
    tituloEs: "Seguridad de la IA via debate: supervisión de IA con jueces débiles",
    ...
    descripcionCortaEs: "Joaquín analiza los límites de 'seguridad de la IA via debate' ante modelos con capacidades asimétricas y demuestra cómo el diseño del protocolo puede forzar la honestidad de la IA.",
    ...
    expositor: {
      ...
      tituloEs: "**Licenciado en Ciencias de Datos & Investigador en seguridad de la IA**",
...
},
{
    ...
    tagEn: "Career",
    tituloEs: "Carrera en seguridad de la IA: una historia personal desde Buenos Aires",
    tituloEn: "A career in AI safety: a personal story from Buenos Aires",
    textoEs: "En esta charla, Eitan Sprejer ha compartido su trayectoria personal en el campo de la seguridad de la IA, y ha señalado que casi nada de lo conseguido ha sucedido en aislamiento, siendo el establecimiento de contactos probablemente lo más importante que se puede estar haciendo para avanzar en este campo. Ha explicado que fundar BAISH, la red argentina de seguridad de la IA, ha sido una de las decisiones más importantes de su carrera, pues le ha conectado tanto con la red local como con la global, y a partir de ahí ha ofrecido su consejo para quien quiera abrirse camino en seguridad de la IA: acudir a eventos de la red local y, sobre todo, de la global, conectar con personas a través de contactos personales o mensajes en frío, ofrecer ayuda y construir cosas en público, pues estas son algunas de las acciones de mayor impacto que se pueden llevar a cabo para la propia carrera.",
  ...
  {
    id: "mythos-fable-gpt-5-6-control-estatal-ia-frontera",
    tagEs: "Gobernanza de la IA",
    tagEn: "AI Governance",
    tituloEs: "Mythos, Fable y GPT-5.6: ¿ha comenzado la era del control estatal de la IA de frontera?",
    tituloEn: "Mythos, Fable and GPT-5.6: has the era of state control over frontier AI begun?",
    textoEs: "Dani Lupión, secretario de PauseAI España e ingeniero de software con más de veinte años de trayectoria en la industria, analiza los recientes episodios de restricción gubernamental sobre modelos de frontera, entre ellos la suspensión y posterior restablecimiento del acceso a Mythos y Fable, para plantear si estos hechos marcan el inicio de una etapa de intervención estatal más directa sobre el desarrollo de la inteligencia artificial de frontera, y qué implicaciones tiene esto para la seguridad de la IA.",
    textoEn: "Dani Lupión, secretary of PauseAI España and a software engineer with more than twenty years in the industry, examines recent episodes of government restriction on frontier models, including the suspension and later restoration of access to Mythos and Fable, to ask whether these events mark the start of a more direct era of state intervention over frontier AI development, and what this means for AI safety.",
    ...
    presentacion: "https://pauseai.es/presentaciones/control-estatal-ias-2026-07/1",
    expositor: {
      id: "dani-lupion",
      nombre: "Dani",
      apellido: "Lupión",
      tituloEs: "Secretario de PauseAI España y Principal Software Engineer en The Workshop",
      tituloEn: "Secretary of PauseAI España and Principal Software Engineer at The Workshop",
      imagen: "",
      bioEs: "Desde su rol como secretario de PauseAI España, rama local de la organización global que aboga por una pausa controlada en el desarrollo de la inteligencia artificial de frontera hasta contar con garantías institucionales de seguridad, Dani aporta algo poco habitual dentro de este movimiento, la mirada de quien lleva más de veinte años trabajando dentro de la propia industria del software, en la actualidad como Principal Software Engineer en The Workshop, y que, aun conociendo el sector desde dentro, defiende con firmeza que hace falta frenar la carrera de la IA antes de seguir avanzando.",
      bioEn: "As secretary of PauseAI España, the local branch of the global organisation that advocates for a controlled pause in the development of frontier artificial intelligence until institutional safety guarantees are in place, Dani brings something uncommon within this movement, the perspective of someone who has worked inside the software industry itself for more than twenty years, currently as Principal Software Engineer at The Workshop, and who, despite knowing the sector from the inside, firmly argues that the AI race needs to be slowed down before going any further.",
      linkedin: "https://www.linkedin.com/in/dani-lupion/",
      email: "",
      web: "",
    },
  ...
  {
    id: "detectando-sesgos-contextuales-en-modelos-de-lenguaje",
    tagEs: "IA responsable",
    tagEn: "Responsible AI",
    tituloEs: "Detectando sesgos contextuales en modelos de lenguaje",
    tituloEn: "Detecting contextual biases in language models",
    textoEs: "Melissa Robles presenta su investigación sobre la detección de sesgos en modelos supervisados y modelos de lenguaje, con especial atención a los sesgos contextuales en el idioma español, en el marco de su trabajo en inteligencia artificial responsable (RAI), incluyendo su participación en el proyecto SESGO (Spanish Evaluation of Stereotypical Generative Outputs).",
    textoEn: "Melissa Robles presents her research on bias detection in supervised models and language models, with particular attention to contextual biases in Spanish, as part of her work in Responsible AI (RAI), including her involvement in the SESGO project (Spanish Evaluation of Stereotypical Generative Outputs).",
    descripcionCortaEs: "Melissa es matemática con maestría en Ingeniería de Sistemas y nos presenta su investigación sobre la detección de sesgos en modelos supervisados y modelos de lenguaje, con especial atención a los sesgos contextuales en el idioma español.",
    descripcionCortaEn: "Melissa is a mathematician with a master's degree in Systems Engineering, presenting her research on bias detection in supervised models and language models, with particular attention to contextual biases in the Spanish language.",
    ...
    expositor: {
      id: "melissa-robles",
      nombre: "Melissa",
      apellido: "Robles Carmona",
      tituloEs: "Data Scientist en Sezzle (sector fintech)",
      tituloEn: "Data Scientist at Sezzle (fintech sector)",
      imagen: "",
      bioEs: "Matemática con maestría en Ingeniería de Sistemas de la Universidad de los Andes de Colombia, en su rol profesional se desempeña como Data Scientist en el sector fintech en Sezzle, y cuenta con experiencia liderando proyectos de consultoría en minería de datos. En el ámbito académico, ha enfocado su investigación en la inteligencia artificial responsable (RAI), especialmente en la detección de sesgos en modelos supervisados y modelos de lenguaje, así como en la creación de modelos de traducción para lenguas indígenas y modelos no supervisados para datos genómicos.",
      bioEn: "A mathematician with a master's degree in Systems Engineering from Universidad de los Andes, Colombia, she works professionally as a Data Scientist in the fintech sector at Sezzle, and has experience leading data mining consultancy projects. Academically, her research has focused on Responsible AI (RAI), particularly bias detection in supervised models and language models, as well as building translation models for indigenous languages and unsupervised models for genomic data.",
      linkedin: "https://www.linkedin.com/in/melissa-robles-carmona/",
      email: "",
      web: "https://ojs.aaai.org/index.php/AIES/article/view/36707",
    },
  },
  {
    id: "cuello-de-botella-seguridad-ia-jose-gelves",
    tagEs: "Carrera y Fieldbuilding",
    tagEn: "Career & Fieldbuilding",
    tituloEs: "El verdadero cuello de botella de la seguridad de la IA (no es lo que crees)",
    tituloEn: "The Real Bottleneck in AI Safety (It's Not What You Think)",
    textoEs: "**José Gelves** expone por qué el cuello de botella de la seguridad de la IA no está en la investigación técnica, sino en la falta de talento generalista, operativo y de coordinación institucional capaz de convertir las ideas ya disponibles en impacto real dentro de gobiernos y organizaciones. Un diagnóstico que enmarca a partir de su experiencia dirigiendo **AI Safety Colombia** y organizando el hub de Bogotá del hackatón **Global South AI Safety** de **Apart Research**.",
    textoEn: "**José Gelves** argues that the real bottleneck in AI safety is not technical research, but the shortage of generalist, operational talent and institutional coordination capable of turning already-available ideas into real impact within governments and organizations. It's a diagnosis he frames through his experience leading **AI Safety Colombia** and organizing the Bogotá hub of **Apart Research**'s **Global South AI Safety** hackathon.",
    descripcionCortaEs: "José Gelves, director de AI Safety Colombia, explica por qué el verdadero cuello de botella de la seguridad de la IA es la falta de talento generalista y de coordinación institucional, no la investigación técnica.",
    descripcionCortaEn: "José Gelves, director of AI Safety Colombia, explains why the real bottleneck in AI safety isn't technical research, but the lack of generalist talent and institutional coordination.",
    imagen: "/seminario_disertantes/Jose_Gelves.png",
    videoYoutube: "https://www.youtube.com/watch?v=z3VUyHcMzMQ",
    fecha: "2026-09-02",
    tagsEs: ["Carrera", "Fieldbuilding", "AI Safety", "Colombia", "Coordinación institucional"],
    tagsEn: ["Career", "Fieldbuilding", "AI Safety", "Colombia", "Institutional Coordination"],
    presentacion: "/material-seminario-jose-gelves.pdf",
    expositor: {
      id: "jose-gelves",
      nombre: "José",
      apellido: "Gelves",
      tituloEs: "**Director de AI Safety Colombia y consultor de transformación digital en la Universidad de los Andes**",
      tituloEn: "**Director of AI Safety Colombia and Digital Transformation Consultant at Universidad de los Andes**",
      imagen: "",
      bioEs: "Politólogo de la **Universidad de los Andes**, con especializaciones en Política Pública y Economía, dirige **AI Safety Colombia**, la principal comunidad de seguridad de la IA del país, y se desempeña como consultor de transformación digital en la **Universidad de los Andes**, en proyectos para el Gobierno colombiano. Es *Pathfinder Fellow* de **Kairos** y embajador de **Apart Research**, organización con la que ha coordinado el hub de Bogotá de su hackatón **Global South AI Safety**.",
      bioEn: "A political scientist from **Universidad de los Andes** with specializations in Public Policy and Economics, he leads **AI Safety Colombia**, the country's leading AI safety community, and works as a digital transformation consultant at **Universidad de los Andes** on projects for the Colombian Government. He is a *Pathfinder Fellow* at **Kairos** and an ambassador for **Apart Research**, an organization with which he has coordinated the Bogotá hub of its **Global South AI Safety** hackathon.",
      linkedin: "https://www.linkedin.com/in/josegelves/",
      email: "",
      web: "https://aisafetycolombia.org",
    },
  },
];