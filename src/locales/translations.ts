export const translations = {
  es: {
    ...
    biblioteca: {
      title: "Biblioteca de Papers",
      subtitle: "Colección de papers científicos sobre seguridad de la IA traducidos y comentados por la comunidad de AI Safety España.",
      ...
      originalAuthors: "Autores originales",
    },
    subscribe: {
  ...
  en: {
    ...
    biblioteca: {
      ...
      subtitle: "A curated collection of AI safety scientific papers translated and summarized in Spanish by the community.",
